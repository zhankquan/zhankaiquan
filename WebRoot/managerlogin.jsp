        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <html:form action="/managerlogin" method="post">
                <div class="form-group">
                  <label for="exampleInputEmail">管理员账号</label>
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="管理员账号" name="account">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control form-control-lg border-left-0" id="exampleInputPassword" placeholder="管理员密码" name="password">                        
                  </div>
                </div>
                ...
                <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="登录">
                  ...
                  <a style="color: white;" href="login.jsp" >普通用户登录</a>
                  </button>
                </div>
