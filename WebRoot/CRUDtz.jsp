...
<%
	...
	String status=new String(request.getParameter("status").getBytes("ISO-8859-1"),"GB18030"); 
	String office=new String(request.getParameter("office").getBytes("ISO-8859-1"),"GB18030"); 
	String date=new String(request.getParameter("date").getBytes("ISO-8859-1"),"GB18030"); 
          ...
          <div class="row">
            ...
            <div >
              ...
              <div class="card" id="mydiv">
                 <html:form action="/altertz" method="post">
               <div class="form-group">
		  <h4 class="card-title">修改工作室</h4>
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="name" value=<%=name %> readonly >
                </div>
               
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" name="status" value=<%=status %> readonly  >
                </div>
                 <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="office" value=<%=office %> readonly  >
                </div>
                  <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="date" value=<%=date %> readonly >
                </div>
              <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="price" value=<%=price %>>
                </div>
            ...
            <div >
              ...
              <div class="card" id="mydiv">
                 <html:form action="/addtz" method="post">
               <div class="form-group">
		  <h4 class="card-title">增加工作室</h4>
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="name" placeholder="创始人" >
                </div>
               
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" name="status" placeholder="状态">
                </div>
                 <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="office" placeholder="工作室">
                </div>
                  <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="date" placeholder="创建日期">
                </div>
              <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"  name="price" placeholder="价格">
                </div>
