...
<body>
  ...
  <%
ArrayList stus=(ArrayList)request.getSession().getAttribute("list");
  Customer cus=(Customer)request.getSession().getAttribute("cus1");
  ArrayList stus2=(ArrayList)request.getSession().getAttribute("list5");
%>
...
　　　　		</form>          
    ...
    <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">我投资的工作室</h4>
    					...
    					<tr>
                          ...
                          <td>
                           ...
                           <th>
                             ...
                             <li>
           						 <a href="sale.jsp?price=<%=stu.getPrice() %>&office= <%=stu.getOffice() %>">
              						<span >出售</span>
           						 </a>
         					 </li> 
         					 </th>
