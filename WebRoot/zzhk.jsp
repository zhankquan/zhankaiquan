...
<body>
	...
	<div class="container-scroller">
		...
		<div class="container-scroller">
						...
						<li class="nav-item nav-profile dropdown"><a
							...
							<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
								...
								<a class="dropdown-item" onclick="add()"> <i
									class="mdi mdi-settings text-primary"></i> 设置
								</a> <a class="dropdown-item"
									onclick="document.getElementById('form1').submit();"> <i
									class="mdi mdi-logout text-primary"></i> 登出
									...
									<html:form action="/zzhk" method="post">
										<div class="form-group">
											<input type="text" class="form-control form-control-lg"
												id="exampleInputEmail1" placeholder="转入账号" name="account">
										</div>
										<div class="form-group">
											<input type="text" class="form-control form-control-lg"
												id="exampleInputPassword1" placeholder="金额" name="money">
										</div>
										<button type="submit" class="btn btn-primary mr-2">确定</button>
										<button class="btn btn-light" type="reset" value="menu.jsp">重置</button>
									</html:form>
								</div>
							</div>
			...
			<%if(pagecurrent>1){ %>
			<a href="zzhk.jsp?pageno=1&pageno2=<%=pagecurrent2%>" class="page-next">首页</a>
			<a href="zzhk.jsp?pageno=<%=pagecurrent-1 %>&pageno2=<%=pagecurrent2%>" class="page-next">上一页</a>
			<%} %>
			<span class="page-current">第<%=pagecurrent %>页</span>
			&nbsp;
			<%if(pagecurrent<pagecount){ %>
			<a href="zzhk.jsp?pageno=<%=pagecurrent+1 %>&pageno2=<%=pagecurrent2%>" class="page-next">下一页</a>
			<a href="zzhk.jsp?pageno=<%=pagecount %>&pageno2=<%=pagecurrent2%>" class="page-next">尾页</a>
			<%} %>
		</div>
			...
			<%if(pagecurrent2>1){ %>
			<a href="zzhk.jsp?pageno2=1&pageno=<%=pagecurrent%>" class="page-next">首页</a>
			<a href="zzhk.jsp?pageno2=<%=pagecurrent2-1 %>&pageno=<%=pagecurrent%>" class="page-next">上一页</a>
			<%} %><span class="page-current">第<%=pagecurrent2 %>页</span>
			&nbsp;
			<%if(pagecurrent2<pagecount2){ %>
			<a href="zzhk.jsp?pageno2=<%=pagecurrent2+1 %>&pageno=<%=pagecurrent%>" class="page-next">下一页</a>
			<a href="zzhk.jsp?pageno2=<%=pagecount2 %>&pageno=<%=pagecurrent%>" class="page-next">尾页</a>
			<%} %>
		</div>
											</div>
										</div>
					...
					<footer class="footer">
						<div
							...
							<span
								class="text-muted text-center text-sm-left d-block d-sm-inline-block">2020@软件构造
								<a href="https://www.baidu.com/" target="_blank"></a>
							</span> <span
								class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
								make in 精神小伙<i class="mdi mdi-heart text-danger"></i>
							</span>
						</div>
					</footer>
               ...
               密码
                <div class="form-group">
						<input type="text" class="form-control form-control-lg"
							...
							value=<%=cus.getPassword()%> pattern="[0-9]{6}" title="请输入6位数字">
					</div>
                用户名
                 <div class="form-group">
						<input type="text" class="form-control form-control-lg"
              ...
              <div class="form-group">
					...
					<div class="mt-3">
						<input
							...
							type="submit" value="确定修改">
						<li class="nav-item"><a class="nav-link" href="menu.jsp">
								<i class="mdi mdi-logout text-primary"></i> <span>取消</span>
						</a></li>
					</div>
				</html:form>
			</div>
