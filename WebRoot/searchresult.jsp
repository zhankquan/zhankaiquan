             ...
             <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item" href="wdzh.jsp">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal">张三
                  </h6>
              ...
              <a class="dropdown-item" href="wdzh.jsp">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal">丽莎
                  </h6>
                  <p class="font-weight-light small-text text-muted mb-0">
                    New product launch
                  </p>
              ...
              <a class="dropdown-item" href="wdzh.jsp">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal"> 王五
                  </h6>
                  <p class="font-weight-light small-text text-muted mb-0">
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item">
                ...
                <div class="item-content">
                  <h6 class="font-weight-normal">申请消息</h6>
                  <p class="font-weight-light small-text mb-0 text-muted">
                    2 days ago
                  </p>
                </div>
					 ...
					 <table id="recent-purchases-listing" class="table">
                         ...
                         <tbody>
                          ...
                          <%
                            ...
                            <tr>
                            <th><span>消息内容：<%=systemnew.getText() %><br>
					...
					<form action="apply.do" method="post" id="form">
						...
						<input type="hidden" name="sendername" value=<%=cus.getCname() %>>
							...
							<div class="btn-group btn-group-sm"
											...
											<button type="button" class="btn btn-primary btn-lg" onclick="document.getElementById('form').submit();">发送申请</button>
							</div>
					</div>
					</form>
				</div>
