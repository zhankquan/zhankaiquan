          ...
          <div class="row">
            <div >
              <div class="card" id="mydiv">
               <html:form action="/cunkuan" method="post">
		  <div class="form-group">
		  <h4 class="card-title">请输入存款金额</h4>
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="存款金额" name="money">
                </div>
