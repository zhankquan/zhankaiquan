...
<body>
	...
	<div class="container-scroller">
		...
		<div class="page-icon">									
			...
			<%if(pagecurrent>1){ %>
			<a href="wdzh.jsp?pageno=1" class="page-next">首页</a>
			<a href="wdzh.jsp?pageno=<%=pagecurrent-1 %>" class="page-next">上一页</a>
			<%} %><span class="page-current">第<%=pagecurrent %>页</span>
			&nbsp;
			<%if(pagecurrent<pagecount){ %>
			<a href="wdzh.jsp?pageno=<%=pagecurrent+1 %>" class="page-next">下一页</a>
			<a href="wdzh.jsp?pageno=<%=pagecount %>" class="page-next">尾页</a>
			<%} %>
